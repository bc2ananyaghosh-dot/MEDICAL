    ...
    <footer className="bg-slate-50 border-t border-slate-200 mt-20 z-10 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4 md:col-span-1">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-lg text-slate-900 tracking-tight">ProofScholar</span>
            </div>
            <p className="text-xs text-slate-600 leading-relaxed">
              Privacy-preserving research contribution verification platform built on the Midnight zero-knowledge blockchain.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-600">
              <li><a href="#features" className="hover:text-blue-600 transition-colors">ZK Verification</a></li>
              <li><a href="#how-it-works" className="hover:text-blue-600 transition-colors">How It Works</a></li>
              <li><a href="#privacy" className="hover:text-blue-600 transition-colors">Privacy Model</a></li>
              <li><a href="#benefits" className="hover:text-blue-600 transition-colors">Academic Benefits</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-600">
              ...
              <li><a href="https://github.com" target="_blank" rel="noreferrer" className="hover:text-blue-600 flex items-center gap-1">GitHub Repository <Github className="w-3 h-3"/></a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-600">
              ...
              <li><a href="#security" className="hover:text-blue-600 transition-colors">Compact Audit</a></li>
        ...
        <div className="border-t border-slate-200 mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500">
          <p>© {new Date().getFullYear()} ProofScholar. Built on Midnight ZK Smart Contracts.</p>
